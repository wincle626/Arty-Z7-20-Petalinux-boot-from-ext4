 ...
 */
#define CPPSTDIN "arm-linux-gnueabihf-gcc  -march=armv7-a -marm  -mthumb-interwork -mfloat-abi=hard -mfpu=neon -mtune=cortex-a9 -Wl,--hash-style=gnu  -E"
#define CPPMINUS "-"
#define CPPRUN "arm-linux-gnueabihf-gcc  -march=armv7-a -marm  -mthumb-interwork -mfloat-abi=hard -mfpu=neon -mtune=cortex-a9 -Wl,--hash-style=gnu  -E"
#define CPPLAST "-"
