...
XS_EUPXS(XS_Storable_init_perinterp)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 6630 "Storable.xs"
  init_perinterp(aTHX);
#line 6770 "Storable.c"
    }
    XSRETURN_EMPTY;
}
...
XS_EUPXS(XS_Storable_last_op_in_netorder)
{
    ...
    SP -= items;
    {
#line 6706 "Storable.xs"
  bool result;
#line 6898 "Storable.c"
#line 6708 "Storable.xs"
  if (ix) {
   dSTCXT;
