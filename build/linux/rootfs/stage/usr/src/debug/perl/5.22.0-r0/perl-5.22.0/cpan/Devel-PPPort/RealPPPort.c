...
XS_EUPXS(XS_Devel__PPPort_SvPV_nomg)
{
	...
	SV *	sv = ST(0)
;
#line 1509 "RealPPPort.xs"
                char *str;
                STRLEN len;
#line 2847 "RealPPPort.c"
	IV	RETVAL;
	dXSTARG;
...
#line 1850 "RealPPPort.xs"
                CV* xv;
#line 3481 "RealPPPort.c"
	int	RETVAL;
	dXSTARG;
#line 1852 "RealPPPort.xs"
                RETVAL = 0;
...
;
	int	RETVAL;
	dXSTARG;
#line 1939 "RealPPPort.xs"
                RETVAL = get_cv(name, create) != NULL;
#line 3669 "RealPPPort.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS_EUPXS(XS_Devel__PPPort_get_cvs)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 2143 "RealPPPort.xs"
                CV* xv;
#line 4136 "RealPPPort.c"
	int	RETVAL;
	dXSTARG;
...
;
	I32	flags = (I32)SvIV(ST(1))
;
#line 2265 "RealPPPort.xs"
                I32 i;
#line 4383 "RealPPPort.c"
#line 2267 "RealPPPort.xs"
                for (i=0; i<items-2; i++)
